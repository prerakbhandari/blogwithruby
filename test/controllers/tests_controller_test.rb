...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { content: @test.content, name: @test.name, title: @test.title } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { content: @test.content, name: @test.name, title: @test.title } }
